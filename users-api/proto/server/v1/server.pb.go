...
func (x *GreeterServiceSayHelloResponse) GetRsp() string {
	if x != nil {
		return x.Rsp
	}
	return ""
...
type GreeterServicePullMessagesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreeterServicePullMessagesResponse) Reset() {
	*x = GreeterServicePullMessagesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreeterServicePullMessagesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreeterServicePullMessagesResponse) ProtoMessage() {}

func (x *GreeterServicePullMessagesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_server_v1_server_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreeterServicePullMessagesResponse.ProtoReflect.Descriptor instead.
func (*GreeterServicePullMessagesResponse) Descriptor() ([]byte, []int) {
	return file_server_v1_server_proto_rawDescGZIP(), []int{2}
}

func (x *GreeterServicePullMessagesResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_server_v1_server_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6d, 0x2f, 0x73, 0x79, 0x73, 0x72, 0x61, 0x64, 0x69, 0x75, 0x6d, 0x2f, 0x70, 0x65, 0x74, 0x70,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x63, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3b,
...
var file_server_v1_server_proto_goTypes = []interface{}{
	(*GreeterServiceSayHelloRequest)(nil),      // 0: server.v1.GreeterServiceSayHelloRequest
	(*GreeterServiceSayHelloResponse)(nil),     // 1: server.v1.GreeterServiceSayHelloResponse
	(*GreeterServicePullMessagesResponse)(nil), // 2: server.v1.GreeterServicePullMessagesResponse
	(*PullMessagesRequest)(nil),                // 3: server.v1.PullMessagesRequest
}
var file_server_v1_server_proto_depIdxs = []int32{
	0, // 0: server.v1.GreeterService.SayHello:input_type -> server.v1.GreeterServiceSayHelloRequest
	3, // 1: server.v1.GreeterService.PullMessages:input_type -> server.v1.PullMessagesRequest
	1, // 2: server.v1.GreeterService.SayHello:output_type -> server.v1.GreeterServiceSayHelloResponse
	2, // 3: server.v1.GreeterService.PullMessages:output_type -> server.v1.GreeterServicePullMessagesResponse
...
func file_server_v1_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_server_v1_server_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreeterServiceSayHelloRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_server_v1_server_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreeterServiceSayHelloResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_server_v1_server_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreeterServicePullMessagesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
